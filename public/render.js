...
const PLATFORMS = {
  ...
  // 💜 v0.174: LivePix (API oficial) e 💠 Pix (direto do banco) — «doacao»
  // segue só como apelido do que ficou nos logs antigos
  livepix: {
    name: 'LivePix',
    color: '#7c3aed',
  ...
  pix: {
    name: 'Pix',
    color: '#32bcad',
    icon: 'M12 2 22 12 12 22 2 12zm0 4.2L6.2 12l5.8 5.8 5.8-5.8z',
  },
  doacao: {
    name: 'Pix',
    color: '#32bcad',
